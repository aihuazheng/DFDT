...
class PedesAttr(data.Dataset):
    ...
    def __init__(self, cfg, split, transform=None, target_transform=None, idx=None):
        ...
        data_path = get_pkl_rootpath(cfg.dataset)
...
def get_pkl_rootpath(dataset):
    root = os.path.join("/data/huimin.wang/dataset/", f"{dataset}")
