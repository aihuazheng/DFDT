...
csv_file = '/data/huiminwang/dataset/LIP/TrainVal_pose_annotations/lip_val_set.csv'
...
with open(csv_file, "r") as input_file:
	for row in csv.reader(input_file):
		...
		image_path = '/data/huiminwang/dataset/LIP/trainval_images/val_images/{}.jpg'.format(img_id)
		...
		for idx, point in enumerate(row):
			...
			if idx % 3 == 0:
				...
				save_path = '/data/huiminwang/dataset/LIP/heat_map/val/{}_{}.png'.format(img_id, int(idx / 3))
