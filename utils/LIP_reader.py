...
class LIPDataset(data.Dataset):
    def __init__(self, opt, split='test'):
        ...
        if split == 'train':
            self.data_dir = "/data1/xuran/LIP/LIP/train_images/"
            self.mask_dir = "/data1/xuran/LIP/LIP/TrainVal_parsing_annotations/train_segmentations/"
            self.data_list = "/data1/xuran/LIP/LIP/train_id.txt"

        elif split == 'val':
            self.data_dir = "/data1/xuran/LIP/LIP/val_images/"
            self.mask_dir = "/data1/xuran/LIP/LIP/TrainVal_parsing_annotations/val_segmentations/"
            self.data_list = "/data1/xuran/LIP/LIP/val_id.txt"
        else:
            self.data_dir = "/data1/xuran/LIP/LIP/testing_images/"
            self.mask_dir = None
            self.data_list = "/data1/xuran/LIP/LIP/test_id.txt"
    ...
    def _transform(self, image, label):
        ...
        # label = cv2.resize(label, (scale_size_w/2, scale_size_h/2), interpolation=cv2.INTER_NEAREST)
...
if __name__ == '__main__':
    images, masks = read_labeled_image_list("/data1/xuran/LIP/LIP/train_images/",\
                                            "/data1/xuran/LIP/LIP/TrainVal_parsing_annotations/train_segmentations/", "/data1/xuran/LIP/LIP/train_id.txt")
    ...
    training_data = LIPDataset(opt = opts, split='val')
